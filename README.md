...
Offline idle games (Cookie Clicker + Idle Dungeon) in a single web app. Plays in any mobile browser, installs to the home screen, and works offline. Progress saves automatically in the browser.
